                            ...
                            <Column style="min-width:8rem">
                                <template #body="{data}">
                                    <div class="flex justify-center gap-5">
                                        ...
                                        <button v-show="$page.props.auth.user.id != data.id"  @click="handleDelete(data.id)" class="text-white bg-red-500 hover:bg-red-500/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 me-2 mb-2">
